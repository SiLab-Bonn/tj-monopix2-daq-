...
set_property PACKAGE_PIN F14 [get_ports {J_GPIO_CLK_SER_P[1]}]
set_property PACKAGE_PIN F13 [get_ports {J_GPIO_CLK_SER_N[1]}]
...
set_property PACKAGE_PIN L19 [get_ports {J_GPIO_CLK_SER_P[2]}]
set_property PACKAGE_PIN L20 [get_ports {J_GPIO_CLK_SER_N[2]}]
...
set_property PACKAGE_PIN J18 [get_ports {J_GPIO_CLK_SER_P[3]}] 
set_property PACKAGE_PIN J19 [get_ports {J_GPIO_CLK_SER_N[3]}] 
...
set_property IOSTANDARD LVDS_25 [get_ports J_GPIO_CLK_SER*]
...
set_property PACKAGE_PIN C19 [get_ports {J_GPIO_CLK_SER_P[0]}]
set_property PACKAGE_PIN B19 [get_ports {J_GPIO_CLK_SER_N[0]}]
