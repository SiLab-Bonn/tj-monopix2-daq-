...
# set_property PACKAGE_PIN G11 [get_ports {J_GPIO_CMD_P[0]}]
# set_property PACKAGE_PIN F10 [get_ports {J_GPIO_CMD_N[0]}]
# set_property PACKAGE_PIN C14 [get_ports {J_GPIO_CLK_CMD_P[0]}]
# set_property PACKAGE_PIN C13 [get_ports {J_GPIO_CLK_CMD_N[0]}]
# set_property PACKAGE_PIN D14 [get_ports {J_GPIO_CLK_SEL_P[0]}]
# set_property PACKAGE_PIN D13 [get_ports {J_GPIO_CLK_SEL_N[0]}]
...
set_property PACKAGE_PIN F14 [get_ports {J_GPIO_CMD_P[1]}]
set_property PACKAGE_PIN F13 [get_ports {J_GPIO_CMD_N[1]}]
set_property PACKAGE_PIN E13 [get_ports {J_GPIO_CLK_CMD_P[1]}]
set_property PACKAGE_PIN E12 [get_ports {J_GPIO_CLK_CMD_N[1]}]
set_property PACKAGE_PIN G12 [get_ports {J_GPIO_CLK_SEL_P[1]}]
set_property PACKAGE_PIN F12 [get_ports {J_GPIO_CLK_SEL_N[1]}]
...
set_property PACKAGE_PIN L19 [get_ports {J_GPIO_CMD_P[2]}]
set_property PACKAGE_PIN L20 [get_ports {J_GPIO_CMD_N[2]}]
set_property PACKAGE_PIN G19 [get_ports {J_GPIO_CLK_CMD_P[2]}]
set_property PACKAGE_PIN F20 [get_ports {J_GPIO_CLK_CMD_N[2]}]
set_property PACKAGE_PIN H17 [get_ports {J_GPIO_CLK_SEL_P[2]}]
set_property PACKAGE_PIN H18 [get_ports {J_GPIO_CLK_SEL_N[2]}]
...
set_property PACKAGE_PIN J18 [get_ports {J_GPIO_CMD_P[3]}] 
set_property PACKAGE_PIN J19 [get_ports {J_GPIO_CMD_N[3]}] 
set_property PACKAGE_PIN K16 [get_ports {J_GPIO_CLK_CMD_P[3]}] 
set_property PACKAGE_PIN K17 [get_ports {J_GPIO_CLK_CMD_N[3]}] 
set_property PACKAGE_PIN M17 [get_ports {J_GPIO_CLK_SEL_P[3]}] 
set_property PACKAGE_PIN L18 [get_ports {J_GPIO_CLK_SEL_N[3]}] 
...
set_property IOSTANDARD LVDS_25 [get_ports J_GPIO_CLK_CMD*]
set_property IOSTANDARD LVDS_25 [get_ports J_GPIO_CLK_SEL*]
set_property IOSTANDARD LVDS_25 [get_ports J_GPIO_AUX*]
...
set_property PACKAGE_PIN C19 [get_ports {J_GPIO_CLK_SEL_P[0]}]
set_property PACKAGE_PIN B19 [get_ports {J_GPIO_CLK_SEL_N[0]}]
set_property PACKAGE_PIN E18 [get_ports {J_GPIO_CLK_CMD_P[0]}]
set_property PACKAGE_PIN D18 [get_ports {J_GPIO_CLK_CMD_N[0]}]
set_property PACKAGE_PIN B17 [get_ports {J_GPIO_CMD_P[0]}]
set_property PACKAGE_PIN A17 [get_ports {J_GPIO_CMD_N[0]}]
set_property PACKAGE_PIN C16 [get_ports {J_GPIO_AUX_P[0]}]
set_property PACKAGE_PIN B16 [get_ports {J_GPIO_AUX_N[0]}]
