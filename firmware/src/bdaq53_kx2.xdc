...
set_property PACKAGE_PIN G11 [get_ports {J_GPIO_CLK_P[0]}]
set_property PACKAGE_PIN F10 [get_ports {J_GPIO_CLK_N[0]}]
...
set_property PACKAGE_PIN F14 [get_ports {J_GPIO_CLK_P[1]}]
set_property PACKAGE_PIN F13 [get_ports {J_GPIO_CLK_N[1]}]
...
set_property PACKAGE_PIN L19 [get_ports {J_GPIO_CLK_P[2]}]
set_property PACKAGE_PIN L20 [get_ports {J_GPIO_CLK_N[2]}]
...
set_property PACKAGE_PIN J18 [get_ports {J_GPIO_CLK_P[3]}] 
set_property PACKAGE_PIN J19 [get_ports {J_GPIO_CLK_N[3]}] 
...
set_property IOSTANDARD LVDS_25 [get_ports J_GPIO_CLK*]
...
# set_property PACKAGE_PIN A18 [get_ports {J_GPIO_CLK_P[0]}]
# set_property PACKAGE_PIN A19 [get_ports {J_GPIO_CLK_N[0]}]
# set_property PACKAGE_PIN C19 [get_ports {J_GPIO_CLK_CMD_P[0]}]
# set_property PACKAGE_PIN B19 [get_ports {J_GPIO_CLK_CMD_N[0]}]
# set_property PACKAGE_PIN E18 [get_ports {J_GPIO_CLK_SEL_P[0]}]
# set_property PACKAGE_PIN D18 [get_ports {J_GPIO_CLK_SEL_N[0]}]
